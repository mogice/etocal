...
function kyureki(tm) {
	...
	this.magenoon = Math.floor(tm) + 0.5 - saku[i];
	if(this.magenoon < 0) this.magenoon = Math.floor(tm) + 0.5 - saku[i-1];
	//-----------------------------------------------------------------------
	// 輝面比を求める
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	this.mphase = Math.floor(NORMALIZATION_ANGLE(LONGITUDE_MOON(t) - LONGITUDE_SUN(t)) / 360 * 28 + 0.5);
...
function LONGITUDE_SUN(t) {
	...
	// 摂動項の計算
	//-----------------------------------------------------------------------
	th = 0.0004 * cos( k * NORMALIZATION_ANGLE( 31557 * t + 161 ) );
	th += 0.0004 * cos( k * NORMALIZATION_ANGLE( 29930 * t + 48 ) );
	th += 0.0005 * cos( k * NORMALIZATION_ANGLE( 2281 * t + 221 ) );
	th += 0.0005 * cos( k * NORMALIZATION_ANGLE( 155 * t + 118 ) );
	th += 0.0006 * cos( k * NORMALIZATION_ANGLE( 33718 * t + 316 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 9038 * t + 64 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 3035 * t + 110 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 65929 * t + 45 ) );
	th += 0.0013 * cos( k * NORMALIZATION_ANGLE( 22519 * t + 352 ) );
	th += 0.0015 * cos( k * NORMALIZATION_ANGLE( 45038 * t + 254 ) );
	th += 0.0018 * cos( k * NORMALIZATION_ANGLE( 445267 * t + 208 ) );
	th += 0.0018 * cos( k * NORMALIZATION_ANGLE( 19 * t + 159 ) );
	th += 0.0020 * cos( k * NORMALIZATION_ANGLE( 32964 * t + 158 ) );
...
function LONGITUDE_MOON(t) {
	...
	// 摂動項の計算
	//-----------------------------------------------------------------------
	th = 0.0003 * cos( k * NORMALIZATION_ANGLE( 2322131 * t + 191 ) );
	th += 0.0003 * cos( k * NORMALIZATION_ANGLE( 4067 * t + 70 ) );
	th += 0.0003 * cos( k * NORMALIZATION_ANGLE( 549197 * t + 220 ) );
	th += 0.0003 * cos( k * NORMALIZATION_ANGLE( 1808933 * t + 58 ) );
	th += 0.0003 * cos( k * NORMALIZATION_ANGLE( 349472 * t + 337 ) );
	th += 0.0003 * cos( k * NORMALIZATION_ANGLE( 381404 * t + 354 ) );
	th += 0.0003 * cos( k * NORMALIZATION_ANGLE( 958465 * t + 340 ) );
	th += 0.0004 * cos( k * NORMALIZATION_ANGLE( 12006 * t + 187 ) );
	th += 0.0004 * cos( k * NORMALIZATION_ANGLE( 39871 * t + 223 ) );
	th += 0.0005 * cos( k * NORMALIZATION_ANGLE( 509131 * t + 242 ) );
	th += 0.0005 * cos( k * NORMALIZATION_ANGLE( 1745069 * t + 24 ) );
	th += 0.0005 * cos( k * NORMALIZATION_ANGLE( 1908795 * t + 90 ) );
	th += 0.0006 * cos( k * NORMALIZATION_ANGLE( 2258267 * t + 156 ) );
	th += 0.0006 * cos( k * NORMALIZATION_ANGLE( 111869 * t + 38 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 27864 * t + 127 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 485333 * t + 186 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 405201 * t + 50 ) );
	th += 0.0007 * cos( k * NORMALIZATION_ANGLE( 790672 * t + 114 ) );
	th += 0.0008 * cos( k * NORMALIZATION_ANGLE( 1403732 * t + 98 ) );
	th += 0.0009 * cos( k * NORMALIZATION_ANGLE( 858602 * t + 129 ) );
	th += 0.0011 * cos( k * NORMALIZATION_ANGLE( 1920802 * t + 186 ) );
	th += 0.0012 * cos( k * NORMALIZATION_ANGLE( 1267871 * t + 249 ) );
	th += 0.0016 * cos( k * NORMALIZATION_ANGLE( 1856938 * t + 152 ) );
	th += 0.0018 * cos( k * NORMALIZATION_ANGLE( 401329 * t + 274 ) );
	th += 0.0021 * cos( k * NORMALIZATION_ANGLE( 341337 * t + 16 ) );
	th += 0.0021 * cos( k * NORMALIZATION_ANGLE( 71998 * t + 85 ) );
	th += 0.0021 * cos( k * NORMALIZATION_ANGLE( 990397 * t + 357 ) );
	th += 0.0022 * cos( k * NORMALIZATION_ANGLE( 818536 * t + 151 ) );
	th += 0.0023 * cos( k * NORMALIZATION_ANGLE( 922466 * t + 163 ) );
	th += 0.0024 * cos( k * NORMALIZATION_ANGLE( 99863 * t + 122 ) );
	th += 0.0026 * cos( k * NORMALIZATION_ANGLE( 1379739 * t + 17 ) );
	th += 0.0027 * cos( k * NORMALIZATION_ANGLE( 918399 * t + 182 ) );
	th += 0.0028 * cos( k * NORMALIZATION_ANGLE( 1934 * t + 145 ) );
	th += 0.0037 * cos( k * NORMALIZATION_ANGLE( 541062 * t + 259 ) );
	th += 0.0038 * cos( k * NORMALIZATION_ANGLE( 1781068 * t + 21 ) );
	th += 0.0040 * cos( k * NORMALIZATION_ANGLE( 133 * t + 29 ) );
	th += 0.0040 * cos( k * NORMALIZATION_ANGLE( 1844932 * t + 56 ) );
	th += 0.0040 * cos( k * NORMALIZATION_ANGLE( 1331734 * t + 283 ) );
	th += 0.0050 * cos( k * NORMALIZATION_ANGLE( 481266 * t + 205 ) );
	th += 0.0052 * cos( k * NORMALIZATION_ANGLE( 31932 * t + 107 ) );
	th += 0.0068 * cos( k * NORMALIZATION_ANGLE( 926533 * t + 323 ) );
	th += 0.0079 * cos( k * NORMALIZATION_ANGLE( 449334 * t + 188 ) );
	th += 0.0085 * cos( k * NORMALIZATION_ANGLE( 826671 * t + 111 ) );
	th += 0.0100 * cos( k * NORMALIZATION_ANGLE( 1431597 * t + 315 ) );
	th += 0.0107 * cos( k * NORMALIZATION_ANGLE( 1303870 * t + 246 ) );
	th += 0.0110 * cos( k * NORMALIZATION_ANGLE( 489205 * t + 142 ) );
	th += 0.0125 * cos( k * NORMALIZATION_ANGLE( 1443603 * t + 52 ) );
	th += 0.0154 * cos( k * NORMALIZATION_ANGLE( 75870 * t + 41 ) );
	...
	th += 0.1144 * cos( k * NORMALIZATION_ANGLE( 966404 * t + 276.5 ) );
